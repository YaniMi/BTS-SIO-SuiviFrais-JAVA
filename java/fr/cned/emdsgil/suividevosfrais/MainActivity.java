...
public class MainActivity extends AppCompatActivity {
    ...
    private void cmdTransfert_clic() {
        ((ImageButton)findViewById(R.id.cmdTransfert)).setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                //Toast.makeText(MainActivity.this, "test", Toast.LENGTH_SHORT).show();
                //Test sur le bouton

                Log.d("message", "clic ok sur le bouton transfert****************************************");
                Serializer.serialize(Global.listFraisMois, MainActivity.this);
                recupSerialize();



               //J'ai essayé de faire un envoi des données vers le serveur mais je ne trouve pas l'instruction


                // envoi les informations sérialisées vers le serveur
                //accesDistant.envoi("enreg",FraisMois.convertToJSONArray());
                //accesDistant.envoi("enreg",Global.listFraisMois.convertToJSONArray());
                // en construction
                }
        });
